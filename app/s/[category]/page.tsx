        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2 text-blue-100">
                <a href="/s/water" className="block cursor-pointer hover:text-white transition-colors">
                  Water
                </a>
                <a href="/s/juice" className="block cursor-pointer hover:text-white transition-colors">
                  Juice
                </a>
                <a href="/s/dairy" className="block cursor-pointer hover:text-white transition-colors">
                  Dairy
                </a>
                <a href="/s/accessories" className="block cursor-pointer hover:text-white transition-colors">
                  Accessories
                </a>
              </div>
            </div>
            <div>
              ...
              <div className="space-y-2 text-blue-100">
                <p className="cursor-pointer hover:text-white transition-colors">Our Oasis Website</p>
                <p className="cursor-pointer hover:text-white transition-colors">About Us</p>
                <p className="cursor-pointer hover:text-white transition-colors">Contact Us</p>
              </div>
            </div>
          </div>
