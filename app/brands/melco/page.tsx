...
const melcoProducts = [
  {
    id: 1,
    name: "Melco Natural Spring Water 1.5L - Pack of 6",
    price: 8.4,
    originalPrice: null,
    image: "/placeholder.svg?key=melco1",
    category: "water",
    brand: "melco",
    isNew: false,
    discount: null,
  ...
  {
    id: 2,
    name: "Melco Natural Spring Water 500ml - Pack of 12",
    price: 11.9,
    originalPrice: null,
    image: "/placeholder.svg?key=melco2",
    category: "water",
    brand: "melco",
    isNew: false,
    discount: null,
  ...
  {
    id: 3,
    name: "Melco Natural Spring Water 330ml - Pack of 24",
    price: 16.8,
    originalPrice: null,
    image: "/placeholder.svg?key=melco3",
    category: "water",
    brand: "melco",
    isNew: false,
    discount: null,
...
export default function MelcoBrandPage() {
  const [searchQuery, setSearchQuery] = useState("")
  const [priceRange, setPriceRange] = useState([0, 50])
  const [sortBy, setSortBy] = useState("featured")
  const [viewMode, setViewMode] = useState("grid")

  const filteredProducts = melcoProducts.filter(
    (product) =>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex-1 max-w-2xl mx-8 relative">
              <div className="relative">
                <Input
                  type="text"
                  placeholder="Search Melco products..."
                  value={searchQuery}
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>›</span>
            <span className="text-gray-900 font-medium">Melco</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="flex items-center gap-6">
            <img src="/melco-green-logo.png" alt="Melco" className="h-20 w-auto" />
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Melco</h1>
              <p className="text-gray-600">Natural spring water from pristine sources</p>
            </div>
          </div>
        </div>
      </div>
