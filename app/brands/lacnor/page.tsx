...
const lacnorProducts = [
  {
    id: 1,
    name: "Lacnor Long Life High Protein Milk & Strawberry - Pack of 6",
    price: 7.97,
    originalPrice: null,
    image: "/placeholder.svg?key=lacnor1",
    category: "dairy",
    brand: "lacnor",
    isNew: false,
    discount: null,
  ...
  {
    id: 2,
    name: "Lacnor Long Life High Protein Milk & Chocolate - Pack of 6",
    price: 48.48,
    originalPrice: null,
    image: "/placeholder.svg?key=lacnor2",
    category: "dairy",
    brand: "lacnor",
    isNew: false,
    discount: null,
  ...
  {
    id: 3,
    name: "Lacnor Long Life Full Cream Milk 1L - Pack of 6",
    price: 19,
    originalPrice: null,
    image: "/placeholder.svg?key=lacnor3",
    category: "dairy",
    brand: "lacnor",
    isNew: false,
    discount: null,
  ...
  {
    id: 4,
    name: "Lacnor Essentials Living Tomato Juice 1L",
    price: 7.97,
    originalPrice: null,
    image: "/placeholder.svg?key=lacnor4",
    category: "juice",
    brand: "lacnor",
    isNew: false,
    discount: null,
  ...
  {
    id: 5,
    name: "Lacnor 100% Long Life Mango Juice 1L",
    price: 7.15,
    originalPrice: null,
    image: "/placeholder.svg?key=lacnor5",
    category: "juice",
    brand: "lacnor",
    isNew: false,
    discount: null,
  ...
  {
    id: 6,
    name: "Lacnor 100% Long Life Pineapple Juice 1L",
    price: 7.15,
    originalPrice: null,
    image: "/placeholder.svg?key=lacnor6",
    category: "juice",
    brand: "lacnor",
    isNew: false,
    discount: null,
...
export default function LacnorBrandPage() {
  ...
  const filteredProducts = lacnorProducts.filter(
    (product) =>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex-1 max-w-2xl mx-8 relative">
              <div className="relative">
                <Input
                  type="text"
                  placeholder="Search Lacnor products..."
                  value={searchQuery}
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>›</span>
            <span className="text-gray-900 font-medium">Lacnor</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="flex items-center gap-6">
            <img src="/lacnor-logo-blue.png" alt="Lacnor" className="h-20 w-auto" />
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Lacnor</h1>
              <p className="text-gray-600">Premium dairy and juice products from the UAE's leading brand</p>
            </div>
          </div>
        </div>
      </div>
