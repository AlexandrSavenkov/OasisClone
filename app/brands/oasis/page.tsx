...
export default function OasisBrandPage() {
  ...
  const filteredProducts = oasisProducts.filter(
    (product) =>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex-1 max-w-2xl mx-8 relative">
              <div className="relative">
                <Input
                  type="text"
                  placeholder="Search Oasis products..."
                  value={searchQuery}
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>›</span>
            <span className="text-gray-900 font-medium">Oasis</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="flex items-center gap-6">
            <img src="/oasis-logo-blue.png" alt="Oasis" className="h-20 w-auto" />
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Oasis</h1>
              <p className="text-gray-600">Pure water and quality accessories for your hydration needs</p>
            </div>
          </div>
        </div>
      </div>
