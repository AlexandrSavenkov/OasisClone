...
const bluProducts = [
  {
    id: 1,
    name: "Blu Sparkling Water 500ml - Pack of 6",
    price: 12.85,
    originalPrice: null,
    image: "/placeholder.svg?key=blu1",
    category: "water",
    brand: "blu",
    isNew: false,
    discount: null,
  ...
  {
    id: 2,
    name: "Blu Sparkling Water 330ml - Pack of 12",
    price: 16.19,
    originalPrice: null,
    image: "/placeholder.svg?key=blu2",
    category: "water",
    brand: "blu",
    isNew: false,
    discount: null,
  ...
  {
    id: 3,
    name: "Blu Sparkling Water 1L - Pack of 6",
    price: 17.42,
    originalPrice: null,
    image: "/placeholder.svg?key=blu3",
    category: "water",
    brand: "blu",
    isNew: false,
    discount: null,
  ...
  {
    id: 4,
    name: "Blu Sparkling Pineapple 330ml - Pack of 6",
    price: 22.85,
    originalPrice: null,
    image: "/placeholder.svg?key=blu4",
    category: "water",
    brand: "blu",
    isNew: true,
    discount: null,
...
export default function BluBrandPage() {
  const [searchQuery, setSearchQuery] = useState("")
  const [priceRange, setPriceRange] = useState([0, 50])
  const [sortBy, setSortBy] = useState("featured")
  const [viewMode, setViewMode] = useState("grid")

  const filteredProducts = bluProducts.filter(
    (product) =>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex-1 max-w-2xl mx-8 relative">
              <div className="relative">
                <Input
                  type="text"
                  placeholder="Search Blu products..."
                  value={searchQuery}
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>›</span>
            <span className="text-gray-900 font-medium">Blu</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="flex items-center gap-6">
            <img src="/blu-logo-blue-text.png" alt="Blu" className="h-20 w-auto" />
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Blu</h1>
              <p className="text-gray-600">Premium sparkling water with natural flavors</p>
            </div>
          </div>
        </div>
      </div>
