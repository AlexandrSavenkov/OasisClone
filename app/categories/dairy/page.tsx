...
export default function DairyCategoryPage() {
  ...
  const filteredProducts = dairyProducts.filter(
    (product) =>
      ...
      <nav className="bg-white border-t">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-center gap-8 py-4">
            ...
            <a href="/categories/dairy" className="flex items-center gap-2 text-blue-600 hover:text-blue-700">
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>›</span>
            <span className="text-gray-900 font-medium">Dairy</span>
          </div>
        </div>
      </div>
