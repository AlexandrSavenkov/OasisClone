...
const waterProducts = [
  ...
  {
    id: 6,
    name: "Oasis Zero Sodium Free - Pack of 6 Bottles",
    price: 16.43,
    originalPrice: null,
    image: "/oasis-water-bottles-carton.png",
    category: "water",
...
export default function WaterCategoryPage() {
  const [searchQuery, setSearchQuery] = useState("")
  const [priceRange, setPriceRange] = useState([0, 50])
  const [sortBy, setSortBy] = useState("featured")
  const [viewMode, setViewMode] = useState("grid")

  const filteredProducts = waterProducts.filter(
    (product) =>
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>›</span>
            <span className="text-gray-900 font-medium">Water</span>
          </div>
        </div>
      </div>
