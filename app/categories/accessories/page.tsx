...
const accessoryProducts = [
  ...
  {
    id: 3,
    name: "Water Dispenser Stand - Premium Quality",
    price: 25,
    originalPrice: null,
    image: "/placeholder-9zo34.png",
    category: "accessories",
    brand: "oasis",
    isNew: false,
    discount: null,
  ...
  {
    id: 4,
    name: "Oasis Water Pump - Manual Hand Pump",
    price: 15,
    originalPrice: null,
    image: "/placeholder-0zlfe.png",
    category: "accessories",
    brand: "oasis",
    isNew: false,
    discount: null,
      ...
      <nav className="bg-white border-t">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-center gap-8 py-4">
            ...
            <a href="/categories/accessories" className="flex items-center gap-2 text-blue-600 hover:text-blue-700">
