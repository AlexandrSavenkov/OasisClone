...
const juiceProducts = [
  ...
  {
    id: 4,
    name: "Lacnor Long Life Skimmed Milk 1L - Pack of 6",
    price: 19,
    originalPrice: null,
    image: "/placeholder-sjkt9.png",
    category: "juice",
    brand: "lacnor",
    isNew: false,
    discount: null,
  ...
  {
    id: 5,
    name: "Lacnor Long Life Strawberry Milk 200ml - Pack of 6",
    price: 8.8,
    originalPrice: null,
    image: "/placeholder-hmxhn.png",
    category: "juice",
    brand: "lacnor",
    isNew: false,
    discount: null,
...
export default function JuiceCategoryPage() {
  const [searchQuery, setSearchQuery] = useState("")
  const [priceRange, setPriceRange] = useState([0, 50])
  const [sortBy, setSortBy] = useState("featured")
  const [viewMode, setViewMode] = useState("grid")

  const filteredProducts = juiceProducts.filter(
    (product) =>
      ...
      <nav className="bg-white border-t">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-center gap-8 py-4">
            ...
            <a href="/categories/juice" className="flex items-center gap-2 text-blue-600 hover:text-blue-700">
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>›</span>
            <span className="text-gray-900 font-medium">Juice</span>
          </div>
        </div>
      </div>
